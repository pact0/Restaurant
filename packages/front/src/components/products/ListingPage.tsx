...
<Grid container spacing={2} sx={{width:'59%', background:"white",
    p:1,
    borderRadius:3}}>
<Grid item xs={2}>
...
<FormControl fullWidth variant="standard">
          <InputLabel htmlFor="standard-adornment-amount">Minimalna cena</InputLabel>
          <Input
...
<Grid item xs={2} sx={{ml:0}}>
<FormControl fullWidth variant="standard">
          <InputLabel htmlFor="standard-adornment-amount">Maksymalna cena</InputLabel>
          <Input
            id="standard-adornment-amount"
            value="50"
            startAdornment={<InputAdornment position="start">$</InputAdornment>}
...
<Typography component="legend" sx={{color:"black"}}>Ocena</Typography>
<Rating
